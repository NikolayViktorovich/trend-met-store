          ...
          >
            <div className="bg-white rounded-2xl overflow-hidden border-2 border-gray-200">
              ...
              {steelSheets.map((sheet, index) => (
                <div 
                  key={index}
                  className={`grid grid-cols-2 sm:grid-cols-6 gap-4 p-4 sm:p-6 items-center ${index !== steelSheets.length - 1 ? 'border-b border-gray-200' : ''}`}
                >
                  ...
                  <div className="text-center text-gray-700 hidden sm:block">{sheet.thickness}</div>
                  <div className="text-center text-gray-700 hidden sm:block">{sheet.price}</div>
