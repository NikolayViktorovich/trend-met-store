      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">Оцинковка</h2>
          ...
          {renderTable(galvanizedSteelGroup1)}
          {renderTable(galvanizedSteelGroup2)}
          ...
          >
            <h2 className="text-2xl font-bold mb-6">Преимущества оцинкованной стали с полимерным покрытием:</h2>
