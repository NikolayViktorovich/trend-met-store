        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="order-2 lg:order-1">
                ...
                <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    ...
                    <span>ПРОФЛИСТ (п -Трп 15/20/35/60/575/114)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
              ...
              <div className="order-1 lg:order-2">
                <Slideshow 
                  ...
                  onPrev={() => setCurrentSlide1((prev) => (prev - 1 + placeholderImages.length) % placeholderImages.length)}
                  onNext={() => setCurrentSlide1((prev) => (prev + 1) % placeholderImages.length)}
                />
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="order-1">
                <Slideshow 
                  ...
                  onPrev={() => setCurrentSlide2((prev) => (prev - 1 + placeholderImages.length) % placeholderImages.length)}
                  onNext={() => setCurrentSlide2((prev) => (prev + 1) % placeholderImages.length)}
                />
              </div>
              <div className="order-2">
                ...
                <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>ПРОФЛИСТ (П15 П20, НС35)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>ЛИННЕАРНЫЕ ПАНЕЛИ</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>ПАНЕЛИ ДЛЯ ВЕНТИЛИРУЕМЫХ ФАСАДОВ</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>ПОДКОНСТРУКЦИИ ДЛЯ ВЕНТИЛИРУЕМЫХ ФАСАДОВ (КРОНШТЕЙНЫ, ПРОФИЛИ)</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="order-2 lg:order-1">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
                  Сэндвич-панели поэлементный сборки
                </h2>
                <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>Толщина — 100-150 мм</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>Производство из оцинкованной стали с полимерным покрытием и нержавеющей стали</span>
                  </li>
                </ul>
              </div>
              <div className="order-1 lg:order-2">
                <Slideshow 
                  ...
                  onPrev={() => setCurrentSlide3((prev) => (prev - 1 + placeholderImages.length) % placeholderImages.length)}
                  onNext={() => setCurrentSlide3((prev) => (prev + 1) % placeholderImages.length)}
                />
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="order-1">
                <Slideshow 
                  ...
                  onPrev={() => setCurrentSlide4((prev) => (prev - 1 + placeholderImages.length) % placeholderImages.length)}
                  onNext={() => setCurrentSlide4((prev) => (prev + 1) % placeholderImages.length)}
                />
              </div>
              <div className="order-2">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
                ...
                <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    <span className="text-[#0062dd] font-bold mt-0.5">•</span>
                    <span>Высококачественная штрипса для различных применений</span>
                  </li>
                </ul>
              </div>
            </div>
