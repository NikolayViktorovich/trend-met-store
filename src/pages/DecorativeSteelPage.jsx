...
import chernyjImg from '../assets/dekorat-stal/черный.png'
import klassikaImg from '../assets/dekorat-stal/классика.png'
import volframImg from '../assets/dekorat-stal/вольфрам.png'
import bronzaImg from '../assets/dekorat-stal/бронза.png'
import zolotoImg from '../assets/dekorat-stal/золото.png'

const decorativeSteel = [
  {
    name: 'AISI 304',
    color: 'изумруд',
    image: izumrudImg,
    ...
    <div className="min-h-screen bg-white">
      <Breadcrumbs 
        items={[
          ...
          { label: 'Сталь нержавеющая декоративная' }
        ]} 
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Мы предлагаем декоративную нержавеющую сталь в различных цветовых решениях. Все позиции в наличии на складе.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-xl overflow-hidden border-2 border-gray-200">
              ...
              <div className="hidden sm:block">
                {decorativeSteel.map((steel, index) => (
                  <div 
                    key={index}
                    className={`grid grid-cols-7 gap-4 p-4 sm:p-6 items-center ${index !== decorativeSteel.length - 1 ? 'border-b border-gray-200' : ''}`}
                  >
                    ...
                    <div className="text-center text-gray-700 capitalize">{steel.color}</div>
                    <div className="text-center text-gray-700">{steel.size}</div>
                    <div className="text-center text-gray-700">{steel.thickness}</div>
                    <div className="text-center">
                      <div className="font-semibold text-gray-900">{steel.price}</div>
                      <div className="text-xs text-gray-500">{steel.priceNote}</div>
                    </div>
                    <div className="text-center">
                  ...
                  <div key={index} className="bg-gray-50 rounded-xl p-4">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-700 capitalize mb-2">{steel.color}</div>
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-green-500 text-white">
                          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                          </svg>
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-3">
                ...
                <span>Уникальный эстетичный внешний вид</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Идеально для дизайнерских решений</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                </svg>
                <span>Все позиции в наличии на складе</span>
              </li>
            </ul>
          </motion.div>
...
export default DecorativeSteelPage
