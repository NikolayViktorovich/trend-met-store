...
import ral3003Roll from '../assets/okr-stal/RAL 3003.jpg'
import ral7021Roll from '../assets/okr-stal/RAL 7021.jpg'
import ral7024Roll from '../assets/okr-stal/RAL 7024.jpg'
import ral6005Roll from '../assets/okr-stal/RAL 6005.jpg'

import ral3003Color from '../assets/color-stal/RAL 3003.png'
import ral7021Color from '../assets/color-stal/RAL 7021.png'
import ral7024Color from '../assets/color-stal/RAL 7024.png'
import ral6005Color from '../assets/color-stal/RAL 6005.png'
...
const PaintedSteelPage = () => {
  ...
  const imagesList = paintedSteel.map((steel) => ({
    src: steel.rollImage,
    ...
    <div className="min-h-screen bg-white">
      <Breadcrumbs 
        items={[
          ...
          { label: 'Окрашенная сталь нержавеющая' }
        ]} 
      />
      ...
      <section className="py-8 sm:py-12 md:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-white rounded-xl overflow-hidden border-2 border-gray-200">
              ...
              <div className="hidden sm:block">
                {paintedSteel.map((steel, index) => (
                  <div 
                    key={index}
                    className={`grid grid-cols-7 gap-4 p-4 sm:p-6 items-center ${index !== paintedSteel.length - 1 ? 'border-b border-gray-200' : ''}`}
                  >
                    ...
                    <div className="text-center">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-gray-400 text-white">
                  ...
                  <div key={index} className="bg-gray-50 rounded-xl p-4">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="font-bold text-gray-900 mb-2">{steel.name}</div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          />
                          <span className="text-sm font-medium text-gray-700">{steel.color}</span>
                        </div>
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-gray-400 text-white">
                          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z" clipRule="evenodd"/>
          ...
          >
            <h2 className="text-xl font-bold mb-4">Преимущества окрашенной нержавеющей стали:</h2>
            <ul className="space-y-2">
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                </svg>
                <span>Дополнительная защита от коррозии</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Долговечность покрытия</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                </svg>
                <span>Возможность одностороннего или двустороннего покрытия</span>
              </li>
            </ul>
          </motion.div>
...
export default PaintedSteelPage
